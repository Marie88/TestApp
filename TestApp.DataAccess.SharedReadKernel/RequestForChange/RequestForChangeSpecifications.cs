...
namespace IoCore.SharedReadKernel.RequestForChange
{
    internal static class RequestForChangeSpecifications
    {
        ...
        public static IQueryable<RequestForChange> AreCompleted(this IQueryable<RequestForChange> requestsForChange)
        {
            return requestsForChange.Where(requestForChange => requestForChange.Status == "COMPLETED");
        }
    }
}